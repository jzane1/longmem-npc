...
share it. `conftest.py` and the seven walkers import from here byte-untouched;
every importer inserts the repo root on sys.path before importing this module,
so the app import resolves without a path shim here.
"""
